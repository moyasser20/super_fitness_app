...
void main() {
  ...
  group('AuthRepoImpl register', () {
    test('Should call remote datasource and return AuthResponse<RegisterResponse>', () async {
      // Arrange
      ...
      final successResponse = AuthResponse<RegisterResponse>.success(registerResponse);
      when(mockDatasource.register(registerRequest)).thenAnswer((_) async => successResponse);
    ...
    test('Should return error AuthResponse when datasource returns error', () async {
      // Arrange
      final registerRequest = RegisterRequestModel(
        firstName: 'John',
        lastName: 'Doe',
      ...
      final errorResponse = AuthResponse<RegisterResponse>.error('Email already exists');
      when(mockDatasource.register(registerRequest)).thenAnswer((_) async => errorResponse);
